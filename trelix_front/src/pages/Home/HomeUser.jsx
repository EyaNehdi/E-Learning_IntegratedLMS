            ...
            <div className="col-lg-12">
              <div className="d-md-flex align-items-center banner-content">
                ...
                <h1 className="display-1 fw-bold">
                  Education is the Way to <span className="color">Success</span>
                </h1>
                <div className="banner-info">
                  <p className="display-5">
                    Education is a key to success and freedom from all the forces is a power and makes a person powerful
                  </p>
                  <a href="/allcours" className="btn btn-primary shadow mt-3 rounded-5">
                    Get Started on your first course
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="banner-stat bg-secondary p-4">
            <div className="d-flex single-stat">
              ...
              <div className="stat-info text-info ms-4">
                ...
                <div className="display-3">
                  <span data-purecounter-start={0} data-purecounter-end={8754} className="purecounter">
                    {countStudent}
                  </span>
                  +
                </div>
            ...
            <div className="d-flex single-stat">
              ...
              <div className="stat-info text-info ms-4">
                {/* Instructor count */}
                <div className="display-3">
                  <span data-purecounter-start={0} data-purecounter-end={245} className="purecounter">
                    {countInstructor}
                  </span>
                  +
                </div>
            ...
            <div className="d-flex single-stat">
              ...
              <div className="stat-info text-info ms-4">
                {/* Course count */}
                <div className="display-3">
                  <span data-purecounter-start={0} data-purecounter-end={15} className="purecounter">
                    {countCourses}
                  </span>
                  +
                </div>
          ...
          <div className="row align-items-center">
            <div className="col-sm-8 col-lg-7">
              <div className="consul-txt">
                <span className="badge-lg bg-info text-primary rounded-5">Conception and Development</span>
                <h2 className="sec-title text-info">
                  Checkout how this platform has been developped by <span className="color">DevStorm</span>
                </h2>
              </div>
            </div>
            <div className="col-sm-4 col-lg-3 offset-lg-2">
              <div className="consul-video text-center">
                <div className="video-block position-relative">
                  ...
                  <a className="cover-video" href="https://github.com/EyaNehdi/E-Learning_IntegratedLMS">
          ...
          <div className="row">
                ...
                <div className="category-entry active d-flex p-3 p-xl-4 align-items-center">
                  ...
                  <div className="cat-info ms-4">
                    <h3 className="display-3">
                      <span data-purecounter-start={0} data-purecounter-end={8871} className="purecounter">
                        {countStudent}
                      </span>
                      +
                    </h3>
            ...
            <div className="col-xl-5 offset-xl-1 col-md-8">
              <div className="about-txt">
                ...
                <h2 className="sec-title">
                  We Makes a Door to <span className="color">Bright Future</span>
                </h2>
        ...
        <div className="container">
          <div className="d-flex justify-content-between align-items-top">
            ...
            <div className="custom-nav d-flex gap-3 align-items-center">
              <button
                className="button-next rounded-circle bg-white shadow-sm p-3 d-flex align-items-center justify-content-center"
                style={{ width: "48px", height: "48px", border: "none", cursor: "pointer" }}
              >
                <i className="feather-icon icon-arrow-left" style={{ fontSize: "20px" }} />
              </button>
              <button
                className="button-prev rounded-circle bg-white shadow-sm p-3 d-flex align-items-center justify-content-center"
                style={{ width: "48px", height: "48px", border: "none", cursor: "pointer" }}
              >
                <i className="feather-icon icon-arrow-right" style={{ fontSize: "20px" }} />
              </button>
            </div>
          </div>
        </div>
                ...
                <div className="course-entry-3 card rounded-2 bg-white border">
                  <div className="card-media position-relative">
                    <a href={`/chapters/${course.slug}`}>
                      <img className="card-img-top" src={course.image || "assets/images/crs.png"} alt={course.title} />
                    </a>
                  </div>
                ...
                <div className="swiper-wrapper">
                  ...
                  <div className="swiper-slide">
                    <div className="review-entry">
                      <p>
                        Education is the most powerful tool to change the world One thing that can’t be taken from you.
                        A mind is a terrible thing to waste. Education is a key to success and freedom from all the
                        forces to learn
                      </p>
                  ...
                  <div className="swiper-slide">
                    <div className="review-entry">
                      <p>
                        We love to purse a best education platform for all. Ipsam quos omnis nisi repudiandae, deleniti
                        eum cupiditate qui tempore animi quaerat modi in possimus consequatur, commodi Lorem ipsum dolor
                        sit amet.
                      </p>
              ...
              <ul className="nav nav-tabs ct-tab" id="myTab" role="tablist">
                <li className="nav-item" role="presentation">
                  <button
                    ...
                    aria-selected="true"
                  >
                    <img src="assets/images/icons/instructor.png" alt />
                ...
                <li className="nav-item" role="presentation">
                  <button
                    ...
                    aria-selected="false"
                  >
                    <img src="assets/images/icons/headphone.png" alt />
                    24/7 Strong Support
                  </button>
                </li>
              </ul>
                    ...
                    <div className="col-lg-5">
                      <div className="choose-txt">
                        ...
                        <blockquote className="bg-shade text-dark display-6 my-4">
                          L’apprentissage est la clé pour transformer le potentiel en réussite. Sur Trelix, chaque cours
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-5">
                      <div className="choose-txt">
                        ...
                        <blockquote className="bg-shade text-dark display-6 my-4">
                          Education enlightens minds and broadens horizons. The beginnings can be challenging, but the
                          results transform a life.
                        </blockquote>
                        <ul>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-5">
                      <div className="choose-txt">
                        ...
                        <blockquote className="bg-shade text-dark display-6 my-4">
                          Education transforms closed minds into open ones. It requires effort, but its fruits shape a
                          better future.
                        </blockquote>
                        <ul>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-5">
                      <div className="choose-txt">
                        ...
                        <blockquote className="bg-shade text-dark display-6 my-4">
                          Chez Trelix, nous croyons que chaque apprenant mérite un soutien continu. Parce qu’apprendre
                          ne s’arrête jamais, notre aide non plus.
                        </blockquote>
                        <ul>
