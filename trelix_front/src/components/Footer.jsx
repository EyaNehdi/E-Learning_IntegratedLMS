...
<div className="container">
    ...
    <div className="col-lg-3 col-sm-6">
      <div className="footer-widget about-footer mt-5">
        <div className="f-logo">
          <a href="index-2.html"><img src="assets/images/trelix_blanc.png" alt="Logo" /></a>
        </div>
        <a href="tel:298228289" className="display-4 " style={{ color: "#007bff", textDecoration: "none" }}>(+216) 71 888 999</a>
        <ul className="mt-4">
  ...
  >
    <span>Support@Trelix.tn</span>
          ...
          <li className="d-flex align-items-center" style={{ color: "inherit", transition: "color 0.3s" }} 
    onMouseOver={(e) => e.target.style.color = "#007bff"} 
    onMouseOut={(e) => e.target.style.color = "inherit"}>
            <span  style={{ color: "inherit", transition: "color 0.3s" }} 
    onMouseOver={(e) => e.target.style.color = "#007bff"} 
    onMouseOut={(e) => e.target.style.color = "inherit"} ><i className="feather-icon icon-map-pin" /></span>
  ...
  <div className="row footer-bottom">
    <div className="col-lg-6 col-sm-6 order-2 order-sm-1">
      <p className="m-0 text-mute">© 2025 Created by <a style={{ color: "#007bff" }} href="#">DevStorm</a>. All Rights Reserved.</p>
    </div>
    <div className="col-lg-6 col-sm-6 order-1 order-sm-2">
      <div className="social-share-alt text-lg-end text-mute">
        ...
        <a href="https://github.com/EyaNehdi/E-Learning_IntegratedLMS"><img src="assets/images/icons/github-mark-white.png" alt /></a>
      </div>
    </div>
  </div>
</div>
