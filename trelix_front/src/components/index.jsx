...
<Header/>
        ...
        <div className="col-lg-12">
          <div className="d-md-flex align-items-center banner-content">
            ...
            <div className="banner-info">
              ...
              <a href="#" className="btn btn-primary shadow mt-3 rounded-5">Get Free Consultation</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="banner-stat bg-secondary p-4">
        <div className="d-flex single-stat">
          ...
          <div className="stat-info text-info ms-4">
            <div className="display-3"><span data-purecounter-start={0} data-purecounter-end={8754} className="purecounter">0</span>+</div>
        ...
        <div className="d-flex single-stat">
          ...
          <div className="stat-info text-info ms-4">
            <div className="display-3"><span data-purecounter-start={0} data-purecounter-end={245} className="purecounter">0</span>+</div>
        ...
        <div className="d-flex single-stat">
          ...
          <div className="stat-info text-info ms-4">
            <div className="display-3"><span data-purecounter-start={0} data-purecounter-end={15} className="purecounter">0</span>+</div>
            <p>Premium Courses</p>
          </div>
        </div>
      </div>
  ...
  <section className="categories-sec sec-padding position-relative">
    <div className="container">
      ...
      <div className="row g-4">
        <div className="col-lg-4 col-md-6">
          <a href="courses.html" className="category-entry d-flex bg-info p-3 p-xl-4 align-items-center">
            ...
            <div className="cat-info">
              <h4 className="display-5">Art and Design</h4>
        ...
        {/* Category Entry End */}
        <div className="col-lg-4 col-md-6">
          <a href="courses.html" className="category-entry active d-flex p-3 p-xl-4 align-items-center">
            <span className="icon-lg rounded-circle">
            ...
            <div className="cat-info">
              <h4 className="display-5">Web Development</h4>
              <small>23 Total Courses</small>
            </div>
          </a>
        </div>
        ...
        <div className="col-lg-4 col-md-6">
          <a href="courses.html" className="category-entry d-flex bg-info p-3 p-xl-4 align-items-center">
            ...
            <div className="cat-info">
              <h4 className="display-5">Apps Development</h4>
              <small>23 Total Courses</small>
            </div>
          </a>
        </div>
  ...
  {/* CTA Section Start */}
  <section className="cta-1 overly" style={{background: 'url("assets/images/cta-bg.jpg") no-repeat center center / cover'}}>
    <div className="container">
      <div className="row align-items-center">
        <div className="col-sm-8 col-lg-7">
          <div className="consul-txt">
            <span className="badge-lg bg-info text-primary rounded-5">Get Free Consultation</span>
            <h2 className="sec-title text-info">If You Need Have Any Query Just <span className="color">Say Hello</span></h2>
          </div>
        </div>
        <div className="col-sm-4 col-lg-3 offset-lg-2">
          <div className="consul-video text-center">
            <div className="video-block position-relative">
              ...
              <a className="cover-video" href="https://www.youtube.com/watch?v=tUP5S4YdEJo"><img src="assets/images/icons/play.png" alt /></a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="about-media overly">
            <div className="category-entry active d-flex p-3 p-xl-4 align-items-center">
              ...
              <div className="cat-info ms-4">
                <h3 className="display-3"><span data-purecounter-start={0} data-purecounter-end={8871} className="purecounter">0</span>+</h3>
  ...
  <section className="team-sec bg-shade sec-padding position-relative">
    ...
    <div className="container">
      ...
      <div className="row justify-content-center g-3 g-lg-4">
        <div className="col-lg-4 col-md-6">
          <div className="teacher-entry position-relative active" style={{backgroundImage: 'url("images/teacher2.jpg")'}}>
            <div className="teacher-info position-absolute p-3">
              ...
              <div className="teacher-intro p-4 text-center">
                ...
                <h3 className="display-4 mb-1"><a className="text-reset" href="single-instructor.html">Charlotte Wilson</a></h3>
                <span className="designation">Department Head (Math)</span>
              </div>
            </div>
          </div>
          {/* Teacher Entry End */}
        ...
        <div className="col-lg-4 col-md-6">
          <div className="teacher-entry position-relative" style={{backgroundImage: 'url("images/teacher1.jpg")'}}>
            <div className="teacher-info position-absolute p-3">
              <ul className="teacher-socials position-absolute list-unstyled">
                <li>
                  <a href="#"><img src="assets/images/icons/fb.png" alt /></a>
              ...
              <div className="teacher-intro p-4 text-center">
                ...
                <h3 className="display-4 mb-1"><a className="text-reset" href="single-instructor.html">Matthew John</a></h3>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="teacher-entry position-relative" style={{backgroundImage: 'url("images/teacher3.jpg")'}}>
            <div className="teacher-info position-absolute p-3">
              <ul className="teacher-socials position-absolute list-unstyled">
                <li>
                  <a href="#"><img src="assets/images/icons/fb.png" alt /></a>
              ...
              <div className="teacher-intro p-4 text-center">
                ...
                <h3 className="display-4 mb-1"><a className="text-reset" href="single-instructor.html">Sophia Adams</a></h3>
                <span className="designation">Department Head (English)</span>
              </div>
            </div>
          </div>
          {/* Teacher Entry End */}
  ...
  <section className="blog-sec bg-shade sec-padding">
    <div className="container">
      <div className="d-md-flex justify-content-between align-items-top mb-5 mb-lg-0">
        <div className="sec-intro">
          <span className="badge-lg bg-primary rounded-5">Blog &amp; News</span>
          <h2 className="sec-title mb-0">Latest From Our <span className="color">Blogs</span></h2>
        </div>
        <a href="blog.html" className="btn btn-primary align-self-start shadow rounded-5">Read all Blog</a>
      </div>
      <div className="row">
        <div className="col-lg-6">
          <article className="single-entry position-relative">
            <figure className="entry-media overflow-hidden">
              <a href="single-post.html"><img src="assets/images/blog1.png" alt="Blog" /></a>
            </figure>
            <div className="entry-content position-absolute">
              <div className="content-header">
                <div className="d-flex entry-meta justify-content-between">
                  <span><i className="feather-icon icon-user" />By <a href="#">Admin</a></span>
                  <span><i className="feather-icon icon-clock" />3 Min Read</span>
                  <span><i className="feather-icon icon-calendar" />21 Dec, 2024</span>
                </div>
                <h3 className="display-4 mt-2 font-bold"><a href="single-post.html" className="text-reset">Dream Big, Learn More, Achieve Beyond Education</a></h3>
              </div>
              <div className="entry-hover">
                ...
                <a href="single-post.html" className="link-primary fw-bold">Read More <i className="feather-icon icon-arrow-right" /></a>
              </div>
            </div>
          </article>
          {/* Article Entry End */}
        ...
        <div className="col-lg-6">
          <article className="single-entry position-relative">
            <figure className="entry-media overflow-hidden">
              <a href="single-post.html"><img src="assets/images/blog2.jpg" alt="Blog" /></a>
            </figure>
            <div className="entry-content position-absolute">
              <div className="content-header">
                <div className="d-flex entry-meta justify-content-between">
    ...
    <div className="container">
      <div className="row align-items-center">
        <div className="col-lg-8">
          <span className="badge-lg bg-white text-primary rounded-5">Get Every Single Updates</span>
          <h2 className="display-2 fw-bold text-info">Subscribe <span className="color-info">Newsletter</span></h2>
        </div>
        <div className="col-lg-4">
          <div className="newsletter-form">
            <form action="#">
              <input className="form-control rounded-5 bg-info" type="email" placeholder="Email Address" />
              <button className="btn btn-secondary w-100 rounded-5 mt-4">Subscribe Newsletter</button>
            </form>
          </div>
        </div>
      </div>
