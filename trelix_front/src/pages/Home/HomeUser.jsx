    ...
    <>
      <div>
        ...
        <section className="categories-sec sec-padding position-relative">
          <div className="container">
            <img
              src="assets/images/icons/dots1.png"
              alt="Dot 1"
              className="anim-img"
            />
            ...
            <div className="row g-4">
              <div className="col-lg-4 col-md-6">
                <a
                  href="courses.html"
                  className="category-entry d-flex bg-info p-3 p-xl-4 align-items-center"
                >
              ...
              <div className="col-lg-4 col-md-6">
                <a
                  href="courses.html"
                  className="category-entry active d-flex p-3 p-xl-4 align-items-center"
                >
                  <span className="icon-lg rounded-circle">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
