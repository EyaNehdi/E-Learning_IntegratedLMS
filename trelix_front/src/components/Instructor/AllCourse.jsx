...
function Allcourse() {
  ...
  useEffect(() => {
    ...
    if (showingRecommendations && recommendations.length > 0) {
      ...
      if (accessFilter === "locked") {
        filtered = filtered.filter(
          (course) => !courseAccess[course._id] && course.price > 0
        );
  ...
  const handleCourseAccess = async (course, e) => {
    ...
    if (!user || user.balance < course.price) {
      Swal.fire({
        ...
        text: `You need ${
          course.price
        } Trelix Coins to unlock this course. Your current balance is ${
          user ? user.balance : 0
        } Coins.`,
  ...
  const fetchRecommendations = useCallback(async () => {
    ...
    try {
      const response = await axios.get(
        `https://trelix-xj5h.onrender.com/recommendation/recommendation`,
        {
          withCredentials: true,
        }
      );
            ...
            <div className="col-lg-8">
              ...
              {showingRecommendations && recommendations.length > 0 && (
                <div className="alert alert-info d-flex align-items-center mb-4">
                  ...
                  <div>
                    <strong>Personalized for You:</strong> Showing courses
              ...
              {showingRecommendations &&
                ...
                !recommendationsLoading && (
                  <div className="alert alert-warning d-flex align-items-center mb-4">
                    ...
                    <div>
                      <strong>No Recommendations Available:</strong> We don't
                      have enough data to make personalized recommendations yet.
                      Try exploring more courses to get better recommendations!
                    </div>
                  </div>
                )}
                ...
                >
                  {accessFilter === "unlocked" ? (
                    <>
                      ...
                      <div>
                        <strong>Showing Unlocked Courses:</strong> Displaying
                    ...
                    <>
                      ...
                      <div>
                        <strong>Showing Locked Courses:</strong> Displaying
                        courses you haven't purchased yet.
                      </div>
                    </>
                  )}
                </div>
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              {showingRecommendations &&
                                recommendations.some(
                                  (rec) =>
                                    (rec.courseId || rec._id) === course._id
                                ) && (
