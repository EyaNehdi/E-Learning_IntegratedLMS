...
const Index = () => {
  ...
  // Fetch categories, students, instructors, courses, and meet instructors
  useEffect(() => {
  ...
  useEffect(() => {
    const playAudio = () => {
      ...
      audio.play().catch((error) => {
        ...
        // Si la lecture automatique échoue (souvent à cause des restrictions des navigateurs),
        // on peut ajouter une interaction utilisateur pour déclencher la lecture
        const handleInteraction = () => {
          audio.play().catch((err) => console.error("Erreur lors de la lecture après interaction:", err));
          document.removeEventListener("click", handleInteraction); // Supprime l'écouteur après la première interaction
        };
