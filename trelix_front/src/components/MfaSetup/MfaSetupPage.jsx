  ...
  const verifyMfa = async () => {
    try {
      const response = await axios.post(
        ...
        { userId: "67ae20123b15b3fdeb784c34", token }
      );
  ...
  const fetchBackupCodes = async () => {
    try {
      const response = await axios.get(
        ...
        { params: { userId: "67ae20123b15b3fdeb784c34" } }
      );
              ...
              <div className="signup-form">
                ...
                {!mfaEnabled && (
                  <>
                    ...
                    <p style={{ fontSize: "0.9rem", opacity: "0.8" }}>
                      ...
                      in addition to your password. This helps protect your
                      account even if your password is compromised.
                    </p>
                    <p style={{ fontSize: "0.8rem", opacity: "0.9" }}>
                      If you wish to start setting up your Multi-Factor
                      Authentication Press the button below
                    </p>
                    <Button
                      variant="contained"
                      onClick={enableMfa}
                ...
                {qrCodeUrl && (!backupCodes || backupCodes.length === 0) && (
                  <>
                    ...
                    >
                      Scan the QR code from your authenticator app and then
                      input the 6 digit verification code generated from the
                      app.
                    </p>
                    <p style={{ fontSize: "0.9rem", opacity: "0.6" }}>
                      Examples of apps you can use are Google Authenticator
                      (Android / iOS) or Microsoft Authenticator (Android / iOS)
                    </p>
                    <div>
                ...
                {qrCodeUrl && !success && (!backupCodes || backupCodes.length === 0) && (
                  <div>
                    <h3 style={{ fontSize: "1.1rem", opacity: "0.8" }}>
                ...
                {backupCodes && backupCodes.length > 0 && (
                  <>
                    ...
                    <Typography variant="body2" color="textSecondary">
                      Use these codes in case you lose access to your
                      authenticator app. Store them securely.
                    </Typography>
                    <Box
                      sx={{
                        display: "grid",
